...
const contentService = {
  ...
  getAllContent: async (token) => {
    try {
      const response = await axios.get(`${apiConfig.API_URL}/api/content`, {
        headers: {
  ...
  getContentById: async (id, token) => {
    try {
      const response = await axios.get(`${apiConfig.API_URL}/api/content/${id}`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  getContentByCreator: async (token) => {
    try {
      const response = await axios.get(`${apiConfig.API_URL}/api/content/creator`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  getPublishedContent: async (token) => {
    try {
      const response = await axios.get(`${apiConfig.API_URL}/api/content/published`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  createContent: async (contentData, token) => {
    try {
      const response = await axios.post(`${apiConfig.API_URL}/api/content`, contentData, {
        headers: {
          'Authorization': `Bearer ${token}`,
  ...
  updateContent: async (id, contentData, token) => {
    try {
      const response = await axios.put(`${apiConfig.API_URL}/api/content/${id}`, contentData, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  deleteContent: async (id, token) => {
    try {
      await axios.delete(`${apiConfig.API_URL}/api/content/${id}`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  publishContent: async (id, token) => {
    try {
      const response = await axios.put(`${apiConfig.API_URL}/api/content/${id}/publish`, {}, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  unpublishContent: async (id, token) => {
    try {
      const response = await axios.put(`${apiConfig.API_URL}/api/content/${id}/unpublish`, {}, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  getContentByClassroom: async (classroomId, token) => {
    try {
      const response = await axios.get(`${apiConfig.API_URL}/api/content/classroom/${classroomId}`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  getPublishedContentByClassroom: async (classroomId, token) => {
    try {
      const response = await axios.get(`${apiConfig.API_URL}/api/content/classroom/${classroomId}/published`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  createContentForClassroom: async (contentData, classroomId, token) => {
    try {
      const response = await axios.post(
        `${apiConfig.API_URL}/api/content/classroom/${classroomId}`, 
        contentData, 
        {
          headers: {
            'Authorization': `Bearer ${token}`,
